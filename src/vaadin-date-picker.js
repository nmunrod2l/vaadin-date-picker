...
class DatePickerElement extends
  ...
  static get template() {
    ...
    <template is="dom-if" id="overlay-template">
      <vaadin-date-picker-overlay id="overlay" fullscreen\$="[[_fullscreen]]" theme\$="[[theme]]" on-vaadin-overlay-open="_onOverlayOpened" on-vaadin-overlay-close="_onOverlayClosed">
        <template>
...
`;
  ...
  _toggle(e) {
    e.stopPropagation();
    this[(this.$.overlay && this.$.overlay.opened) ? 'close' : 'open']();
  }
